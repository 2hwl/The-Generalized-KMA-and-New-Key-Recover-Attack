...
int oracle(const unsigned char * ct, 
           const unsigned char * sk,
           unsigned char * msg_A, int k, int P, int *C3) 
{
  ...
  /* check msg_A[0] given by adversary ==  the m_dec[0] decrypted by oracle */
  poly_frommsg(&temp, m_dec);
